...
export const SUBJECTS: SeedSubject[] = [
  {
    ...
    icon: "📖",
    series: [
      // ================= 777 초등영문법 시리즈 (0권 ~ 6권, 각각 별도 시리즈) =================
      { title: "777 초등영문법 0권", chapters: [
        { title: "0권", lessons: [
